...
define(
  'rs/pru3d/AssetManager',[],function() {
    ...
    AssetManager.prototype.loadTextures = function() {
      ...
      const list = ['shadow.png', 'ShibaTarget1.png', 'grass.png', 'stars_cookie.png'];
...
define('rs/pru3d/ui/GameOverPanel',[
  ...
  function(BasePanel, GameButton) {
    ...
    GameOverPanel.prototype.init = function() {
      ...
      trophy.src = 'assets/graphics/sad_shiba.png';
...
define(
  'rs/pru3d/entity/Obstacle',[],function() {
    ...
    Obstacle.prototype.init = function() {
      ...
      //const list = ['DeadBirch_3', 'DeadBirch_4', 'Rock4', 'Fish', 'Demon'];
      const list = ['Bamboo_3', 'PalmTree_4', 'Bull', 'Cow', 'Wolf'];
    ...
    Obstacle.prototype.animate = function(delta) {
      ...
      if (this.selectedName == 'Bull' || this.selectedName == 'Cow' || this.selectedName == 'Wolf') {
        this.position.z += delta *this.pb.dopt.bullSpeed;
...
define(
  'rs/pru3d/entity/Gift',[],function() {
    ...
    Gift.prototype.init = function() {
      ...
      // Import model
      const bookList = [this.am['MeatLeg']];
 ...
 * @author  raizensoft.com
 */
define('rs/pru3d/entity/Shiba',['rs/pru3d/SparkAnimation'],
  function(SparkAnimation) {
    ...
    Shiba.prototype = Object.create(THREE.Group.prototype);
     ...
     * @constructor
     */
    function Shiba(pb, type) {

      this.pb = pb;
      this.am = pb.am;
      this.speed = pb.dopt.shibaSpeed;
      this.stype = type || 1;
      this.init();
    }
     ...
     * Init
     */
    Shiba.prototype.init = function() {
      
      THREE.Group.prototype.constructor.call(this);

      this.animName = 'ShibaInuAnimations';
      this.walkClip = 'Gallop';

      const model = this.model = this.am['ShibaInu'];
      model.scale.set(MODEL_SCALE, MODEL_SCALE, MODEL_SCALE);
      this.add(model);
      ...
      const targetPlane = this.targetPlane = new THREE.Mesh(
        ...
        new THREE.MeshBasicMaterial({map:this.am.ShibaTarget1, transparent:true, opacity:1}));
     ...
     * @method play
     */
    Shiba.prototype.play = function(name) {
     ...
     * Play walk animation
     */
    Shiba.prototype.playWalk = function() {
     ...
     * @method playOnce
     */
    Shiba.prototype.playOnce = function(name) {
     ...
     */
    Shiba.prototype.update = function(delta) {
      ...
      // Update position
      const speed = delta * d.shibaSpeed;
     ...
     */
    Shiba.prototype.getMatrixPosition = function() {
     ...
     * Reset ninja
     */
    Shiba.prototype.reset = function() {
     ...
     * Hit obstacle
     */
    Shiba.prototype.hitObstacle = function() {
      this.blink();
    };
     ...
     * Blink ninja
     */
    Shiba.prototype.blink = function() {
     ...
     * Shift left
     */
    Shiba.prototype.shiftLeft = function() {
     ...
     * Shift right
     */
    Shiba.prototype.shiftRight = function() {
...
define(
  'rs/pru3d/entity/Floor',[],function() {
    ...
    Floor.prototype.init = function() {
      ...
      //const tex = this.am.snow;
      const tex = this.am.grass;
...
define('rs/pru3d/RunningStage',[
  ...
  function(
    ...
    RunningStage.prototype.init = function() {
      ...
      // Shiba list
      //this.ninjaList = [new Shiba(this, 1), new Shiba(this, 2), new Shiba(this, 3)];
      this.shibaList = [new Shiba(this, 1)];
    };
    ...
    RunningStage.prototype.prepareLevel = function(level) {
      ...
      // Remove old ninja
      this.remove(this.ninja);

      // Pick a new ninja
      const sa = this.ninja = this.shibaList[Math.floor(Math.random() * this.shibaList.length)];
      sa.reset();
