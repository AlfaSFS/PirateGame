...
define(
  'rs/pru3d/AssetManager',[],function() {
    ...
    AssetManager.prototype.loadTextures = function() {
      ...
      const list = ['shadow.png', 'TheCarTarget1.png', 'Road.png', 'stars.png'];
...
define('rs/pru3d/ui/GameOverPanel',[
  ...
  function(BasePanel, GameButton) {
    ...
    GameOverPanel.prototype.init = function() {
      ...
      trophy.src = 'assets/graphics/sad_car.png';
...
define(
  'rs/pru3d/entity/Obstacle',[],function() {
    ...
    Obstacle.prototype.init = function() {
      ...
      const list = ['TrafficSign1', 'SchoolBus', 'Train', 'Ambulance', 'TrafficSign1'];
      ...
      switch (selectedName) {
        ...
        case 'SchoolBus':
          model.scale.set(MODEL_SCALE * 1.5, MODEL_SCALE * 1.5, MODEL_SCALE * 1.5);
          break;
        ...
        case 'Ambulance':
          model.scale.set(MODEL_SCALE * 1.25, MODEL_SCALE * 1.25, MODEL_SCALE * 1.25);
          break;
      }
      /*
      if (selectedName !== 'Bull' && selectedName !== 'Cow' && selectedName !== 'Wolf') {
        //this.rotation.y = Math.random() * 2 * Math.PI;
      }
      if (selectedName === 'Wolf') {

        this.mixer = new THREE.AnimationMixer(this.model);
        this.clipNames = ['Gallop'];
        this.animName = 'WolfAnimations';
        var wolfScale = 1.5;
        model.scale.set(MODEL_SCALE * wolfScale, MODEL_SCALE * wolfScale, MODEL_SCALE * wolfScale);
      }
      if (selectedName === 'Cow') {

        this.mixer = new THREE.AnimationMixer(this.model);
        this.clipNames = ['Gallop'];
        this.animName = 'CowAnimations';
      }
      if (selectedName === 'Bull') {

        this.mixer = new THREE.AnimationMixer(this.model);
        this.clipNames = ['Gallop'];
        this.animName = 'BullAnimations';
        var bullScale = 1;
        model.scale.set(MODEL_SCALE * bullScale, MODEL_SCALE * bullScale, MODEL_SCALE * bullScale);
      }
      */
      this.add(model);
      this.reset();
     ...
     */
    Obstacle.prototype.playRandom = function() {
      
      const name = this.clipNames[Math.floor(Math.random() * this.clipNames.length)];
      this.play(name);
    };
    ...
    Obstacle.prototype.animate = function(delta) {
      ...
      if (this.selectedName == 'SchoolBus' || this.selectedName == 'Train' || this.selectedName == 'Ambulance') {
 ...
 * @author  raizensoft.com
 */
define('rs/pru3d/entity/TheCar',['rs/pru3d/SparkAnimation'],
  function(SparkAnimation) {
    ...
    TheCar.prototype = Object.create(THREE.Group.prototype);
    TheCar.prototype.constructor = TheCar;
     ...
     * @constructor
     */
    function TheCar(pb, type) {

      this.pb = pb;
      this.am = pb.am;
      this.speed = pb.dopt.carSpeed;
      this.stype = type || 1;
      this.init();
    }
     ...
     * Init
     */
    TheCar.prototype.init = function() {
      
      THREE.Group.prototype.constructor.call(this);

      this.animName = 'TheCarInuAnimations';

      var modelName = 'CopCar';

      switch (this.stype) {

        case 2: modelName = 'Taxi'; break;
        case 3: modelName = 'SUV'; break;
        case 4: modelName = 'SportsCar'; break;
        case 5: modelName = 'SportsCar2'; break;
      }
      ...
      const targetPlane = this.targetPlane = new THREE.Mesh(
        ...
        new THREE.MeshBasicMaterial({map:this.am.TheCarTarget1, transparent:true, opacity:1}));
     ...
     * @method play
     */
    TheCar.prototype.play = function(name) {
     ...
     * Play walk animation
     */
    TheCar.prototype.playWalk = function() {
      return;
    };
     ...
     * @method playOnce
     */
    TheCar.prototype.playOnce = function(name) {
     ...
     */
    TheCar.prototype.update = function(delta) {
     ...
     */
    TheCar.prototype.getMatrixPosition = function() {
     ...
     * Reset ninja
     */
    TheCar.prototype.reset = function() {
     ...
     * Hit obstacle
     */
    TheCar.prototype.hitObstacle = function() {
      this.blink();
    };
     ...
     * Blink ninja
     */
    TheCar.prototype.blink = function() {
      ...
      function doBlink () {
        ...
        clearTimeout(ninja.blinkId);
        if (count++ < 12) {
          ninja.visible = !ninja.visible;
          ninja.blinkId = setTimeout(doBlink, 50);
        }
        else {
          ninja.visible = true;
          ninja.isBlinking = false;
        }
      }
      doBlink();
     ...
     * Shift left
     */
    TheCar.prototype.shiftLeft = function() {
     ...
     * Shift right
     */
    TheCar.prototype.shiftRight = function() {
     ...
     * Bounce effect
     */
    TheCar.prototype.bounce = function() {
...
define('rs/pru3d/RunningStage',[
  ...
  function(
    ...
    RunningStage.prototype.init = function() {
      ...
      // TheCar list
      this.carList = [new TheCar(this, 1), new TheCar(this, 2), new TheCar(this, 3), new TheCar(this, 4)];
    };
    ...
    RunningStage.prototype.prepareLevel = function(level) {
      ...
      // Pick a new car
      const sa = this.car = this.carList[Math.floor(Math.random() * this.carList.length)];
      sa.reset();
